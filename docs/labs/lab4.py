...
channel_multipliers = [0.5, 1, 2, 3, 4, 5, 6]
search_space = []
for multiplier in channel_multipliers:
    pass_config['seq_blocks_2']['input_channel_multiplier'] = multiplier
    pass_config['seq_blocks_2']['output_channel_multiplier'] = multiplier
    pass_config['seq_blocks_4']['input_channel_multiplier'] = multiplier
    pass_config['seq_blocks_4']['output_channel_multiplier'] = multiplier
    pass_config['seq_blocks_6']['input_channel_multiplier'] = multiplier
    pass_config['seq_blocks_6']['output_channel_multiplier'] = multiplier
    search_space.append(deepcopy(pass_config))
